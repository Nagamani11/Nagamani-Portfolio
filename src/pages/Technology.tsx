...
const techStack = [
  { name: 'React Native (CLI)', icon: '📱', category: 'Mobile', color: '#61dafb' },
  ...
  { name: 'Django REST Framework', icon: '🔌', category: 'Backend', color: '#a30000' },
  { name: 'PostgreSQL', icon: '🐘', category: 'Database', color: '#336791' },
  { name: 'MySQL', icon: '🗄️', category: 'Database', color: '#4479a1' },
  { name: 'GitHub', icon: '�', category: 'Tools', color: '#080808' },
  { name: 'Power BI', icon: '�', category: 'Tools', color: '#f2c811' },
  { name: 'GoDaddy Hosting', icon: '🌐', category: 'Tools', color: '#1a73e8' },
  { name: 'Firebase', icon: '�', category: 'Cloud', color: '#ffca28' },
  { name: 'Razorpay', icon: '�', category: 'Integrations', color: '#3395ff' },
  { name: 'Google Maps API', icon: '🗺️', category: 'Integrations', color: '#4285f4' },
  { name: 'PyLint', icon: '�', category: 'Tools', color: '#6da8d7' },
  { name: 'ESLint', icon: '📝', category: 'Tools', color: '#4b32c3' },
]
