...
const education = [
  {
    ...
    highlights: [
      ...
      'Final year project: Online Examination Portal using Django and React',
      'Participated in national-level coding competitions (HackFest 2018)',
      'Active member of the Computer Science student association',
      'Completed additional coursework in Data Structures & Algorithms',
    ],
  ...
  },
  {
    ...
    highlights: [
      ...
      'Cleared JEE Mains and EAMCET with competitive scores',
    ],
  ...
  },
  {
    ...
    highlights: [
      ...
      'Subject rank in Mathematics and Science',
